      ...
      <nav className="flex-1 overflow-y-auto px-4 pb-4 flex flex-col gap-0.5">
        ...
        <div>
          ...
          >
            <span
              className={`material-symbols-outlined text-[20px] transition-colors ${
                isAdminActive ? 'text-white' : 'text-[#94a3b8] group-hover:text-[#4f46e5]'
              }`}
            >
              settings
            </span>
            ...
            <span
              ...
              } ${isAdminActive ? 'text-white/70' : 'text-[#c8d0e0]'}`}
            >
              expand_more
            </span>
          </button>
          ...
          >
            <div className="ml-4 pl-3 border-l-2 border-[#e2e8f0] flex flex-col gap-0.5 py-1">
                    ...
                    <>
                      <span
                        className={`material-symbols-outlined text-[16px] ${
                          isActive ? 'text-[#4f46e5]' : 'text-[#c8d0e0]'
                        }`}
                      >
                        {icon}
                      </span>
